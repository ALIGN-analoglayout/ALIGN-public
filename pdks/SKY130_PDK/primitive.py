...
#files copied from default primitives

#############################################################
#primitives for SKY130_PDK (contents copied from OSU180)
#############################################################

# So basically, there are 2 PR's (pull requests)
#1. Installation
#2. Porting ALIGN to work for OSU180

#Installation seems to working fine.
#Porting it to 180 seems to be a challenge as of now. We are working in that direction.



# I do not think OSU180 has various varieties of VT cells.
#Hence I commented out the LVT & HVT part

# I am not quite sure how the self.m2PerUnitCell function works. It is calculating with respect to the "fin" no. and size.
#I think we need to change the method signature to fit our OSU180 PDK.


# I have not run this using ALIGN. I think we need to have a meeting to check the correctness of this file.

#We are only copying code from align/primitive/default/mos.py
#what about via.py/canvas.py?


#In the layers.json file "Fin" is mapped to "active". Is this how it is supposed to be?
...
#Need some help here editing the layer definitions for OSU180. Maybe we should have a meeting with Kunal.
 ...
 # I do not think OSU180 has various varieties of VT cells.
 #Hence I commented out the LVT & HVT part. I don't know what is RVT. (Is it Nominal VT?)
...
# Draw FEOL Layers
#Need some help here.
#Do we need to change the calculation values for our OSU180?
if self.shared_diff == 0:
