...
// Cell name: TB_ADC
// View name: schematic
I0 (CLK DOUT\<5\> DOUT\<4\> DOUT\<3\> DOUT\<2\> DOUT\<1\> DOUT\<0\> IN IP \
        REFN REFP VDD VSS) Asynch_SAR_ADC_6b_2GSPS
I4\<5\> (DOUT\<5\> net09\<0\>) not_gate vlogic_high=1 vlogic_low=0 \
        vtrans=0.4 tdel=0 trise=10p tfall=10p
I4\<4\> (DOUT\<4\> net09\<1\>) not_gate vlogic_high=1 vlogic_low=0 \
        vtrans=0.4 tdel=0 trise=10p tfall=10p
I4\<3\> (DOUT\<3\> net09\<2\>) not_gate vlogic_high=1 vlogic_low=0 \
        vtrans=0.4 tdel=0 trise=10p tfall=10p
I4\<2\> (DOUT\<2\> net09\<3\>) not_gate vlogic_high=1 vlogic_low=0 \
        vtrans=0.4 tdel=0 trise=10p tfall=10p
I4\<1\> (DOUT\<1\> net09\<4\>) not_gate vlogic_high=1 vlogic_low=0 \
        vtrans=0.4 tdel=0 trise=10p tfall=10p
I4\<0\> (DOUT\<0\> net09\<5\>) not_gate vlogic_high=1 vlogic_low=0 \
        vtrans=0.4 tdel=0 trise=10p tfall=10p
I6\<5\> (net09\<0\> D\<5\>) not_gate vlogic_high=1 vlogic_low=0 vtrans=0.4 \
        tdel=0 trise=10p tfall=10p
I6\<4\> (net09\<1\> D\<4\>) not_gate vlogic_high=1 vlogic_low=0 vtrans=0.4 \
        tdel=0 trise=10p tfall=10p
I6\<3\> (net09\<2\> D\<3\>) not_gate vlogic_high=1 vlogic_low=0 vtrans=0.4 \
        tdel=0 trise=10p tfall=10p
I6\<2\> (net09\<3\> D\<2\>) not_gate vlogic_high=1 vlogic_low=0 vtrans=0.4 \
        tdel=0 trise=10p tfall=10p
I6\<1\> (net09\<4\> D\<1\>) not_gate vlogic_high=1 vlogic_low=0 vtrans=0.4 \
        tdel=0 trise=10p tfall=10p
