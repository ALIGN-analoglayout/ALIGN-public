//Verilog block level netlist file for BUFFER_VREFP2
...
module BUFFER_VREFP2 ( ibias, sw<0>, sw<1>, sw<2>, vref, vrefp ); 
input ibias, sw<0>, sw<1>, sw<2>, vref, vrefp;

Switch_PMOS_n12_X1_Y1 xm34 ( .B(vdd), .D(vrefp), .G(net0116), .S(net0121) ); 
Switch_PMOS_n12_X1_Y1 xm33 ( .B(vdd), .D(vrefp), .G(net0116), .S(net0140) ); 
Dcap_PMOS_n12_X1_Y1 xm106 ( .B(vdd), .S(vdd), .G(net076) ); 
DCL_PMOS_n12_X1_Y1 xm27 ( .B(vdd), .D(net076), .S(vfb) ); 
Switch_PMOS_n12_X1_Y1 xm28 ( .B(vdd), .D(vrefp), .G(net0116), .S(net0127) ); 
Switch_PMOS_n12_X1_Y1 xm15 ( .B(vdd), .D(vfb), .G(net450), .S(net0138) ); 
Switch_PMOS_n12_X1_Y1 xm58 ( .B(vdd), .D(vrefp), .G(net0116), .S(net0125) ); 
Switch_NMOS_n12_X1_Y1 xm21 ( .B(net426), .D(net076), .G(ibias), .S(net426) ); 
...
CMC_PMOS_S_n12_X1_Y1 xm35_xm43 ( .B(vdd), .DA(net0110), .G(net076), .S(vrefp), .DB(net0109) ); 
CMC_PMOS_S_n12_X1_Y1 xm29_xm32 ( .B(vdd), .DA(net0116), .G(net076), .S(vrefp), .DB(net0111) ); 
LSB_NMOS_2 xm4_xm36_xm57 ( .B(gnd), .DA(ibias), .SA(net469), .DB(net0110), .SB(net464), .DC(net0109), .SC(net465) ); 
...
CMC_NMOS_n12_X1_Y1 xm30_xm31 ( .B(gnd), .DA(net0116), .G(ibias), .SA(net470), .DB(net0111), .SB(net463) ); 
