//Verilog block level netlist file for BUFFER_VCM_FINAL1
...
module BUFFER_VCM_FINAL1 ( ibias, vcm_in, vout ); 
...
CMB_PMOS_3 xm29_xm30_xm3_xm17 ( .B(vdd), .DA(ibias), .S(vdd), .DB(net132), .DC(net123), .DD(net028) ); 
LSB_NMOS_2 xm2_xm27_xm26 ( .B(gnd), .DA(net123), .SA(gnd), .DB(net128), .SB(net125), .DC(net138), .SC(net065) ); 
DP_PMOS_n12_X1_Y1 xm21_xm19 ( .B(vdd), .DA(net125), .GA(vout), .S(net028), .DB(net065), .GB(vcm_in) ); 
