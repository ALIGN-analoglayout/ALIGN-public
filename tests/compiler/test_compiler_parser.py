...
def test_simple_circuit():
    ...
    assert circuit.elements[0].pins == {'B': 'GND!', 'D': 'VOUT', 'G': 'NET5', 'S': 'GND!'}
    assert model.pins == ['D','G','S','B']
    assert model.parameters == {'L': '1', 'M': '1', 'NF': '1', 'NFIN': '1', 'W': '1', 'PARALLEL': '1', 'STACK': '1'}
    #TBF: Document base model
    assert model.prefix == 'M'
    assert circuit.elements[0].parameters == {'W':'2.7E-08', 'L':'2E-08', 'NFIN':'1', 'NF':'1', 'M':'1','PARALLEL': '1', 'STACK': '1'}
    ...
    assert circuit.elements[1].parameters == {'W': '2.7E-08', 'L': '2E-08', 'NFIN': '1', 'NF': '1', 'M': '1','PARALLEL': '1', 'STACK': '1'}
    ...
    assert circuit.elements[2].parameters == {'W': '2.7E-08', 'L': '2E-08', 'NFIN': '1', 'NF': '1', 'M': '1','PARALLEL': '1', 'STACK': '1'}
