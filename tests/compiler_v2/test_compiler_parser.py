...
def test_simple_circuit():
    ...
    assert circuit.elements[0].parameters == {'W':'2.7E-08', 'L':'2E-08', 'NFIN':'1', 'NF':'1', 'M':'1'}
    ...
    assert circuit.elements[6].model.parameters == {'R':'1','VALUE':'0'}
    ...
    assert circuit.elements[7].model.parameters == {'C':'1','VALUE':'0'}
