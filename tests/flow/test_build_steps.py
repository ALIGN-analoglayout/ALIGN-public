...
def test_A():
    assert ['1_topology','2_primitives', '3_pnr:prep' , '3_pnr:place', '3_pnr:gui', '3_pnr:route'] == build_steps( '1_topology', '3_pnr')

    assert ['1_topology','2_primitives', '3_pnr:prep' , '3_pnr:place', '3_pnr:gui', '3_pnr:route'] == build_steps( '1_topology', '3_pnr:route')
