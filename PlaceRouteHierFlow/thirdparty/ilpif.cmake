...
if(NOT ilpsolverif_POPULATED)
  ...
  find_library(
    ...
    PATHS ${solver_search_path} NO_DEFAULT_PATH)
  if (NOT ilp_solver_lib)
    ...
    find_library(cbc_lib NAMES libCbc.a PATHS ${solver_search_path} NO_DEFAULT_PATH NO_SYSTEM_ENVIRONMENT_PATH)
    set_property(TARGET cbc_if PROPERTY IMPORTED_LOCATION ${cbc_lib})
    find_library(cbcsolver_lib NAMES libCbcSolver.a PATHS ${solver_search_path} NO_DEFAULT_PATH NO_SYSTEM_ENVIRONMENT_PATH)
    set_property(TARGET cbcsolver_if PROPERTY IMPORTED_LOCATION ${cbcsolver_lib})
    find_library(clp_lib NAMES libClp.a PATHS ${solver_search_path} NO_DEFAULT_PATH NO_SYSTEM_ENVIRONMENT_PATH)
    set_property(TARGET clp_if PROPERTY IMPORTED_LOCATION ${clp_lib})
    find_library(cgl_lib NAMES libCgl.a PATHS ${solver_search_path} NO_DEFAULT_PATH NO_SYSTEM_ENVIRONMENT_PATH)
    set_property(TARGET cgl_if PROPERTY IMPORTED_LOCATION ${cgl_lib})
    find_library(osi_lib NAMES libOsi.a PATHS ${solver_search_path} NO_DEFAULT_PATH NO_SYSTEM_ENVIRONMENT_PATH)
    set_property(TARGET osi_if PROPERTY IMPORTED_LOCATION ${osi_lib})
    find_library(osiclp_lib NAMES libOsiClp.a PATHS ${solver_search_path} NO_DEFAULT_PATH NO_SYSTEM_ENVIRONMENT_PATH)
    set_property(TARGET osiclp_if PROPERTY IMPORTED_LOCATION ${osiclp_lib})
    find_library(coinutils_lib NAMES libCoinUtils.a PATHS ${solver_search_path} NO_DEFAULT_PATH NO_SYSTEM_ENVIRONMENT_PATH)
    set_property(TARGET coinutils_if PROPERTY IMPORTED_LOCATION ${coinutils_lib})
    find_library(clpsolver_lib NAMES libClpSolver.a PATHS ${solver_search_path} NO_DEFAULT_PATH NO_SYSTEM_ENVIRONMENT_PATH)
    set_property(TARGET clpsolver_if PROPERTY IMPORTED_LOCATION ${clpsolver_lib})
    find_library(osicbc_lib NAMES libOsiCbc.a PATHS ${solver_search_path} NO_DEFAULT_PATH NO_SYSTEM_ENVIRONMENT_PATH)
    set_property(TARGET osicbc_if PROPERTY IMPORTED_LOCATION ${osicbc_lib})
    find_library(sym_lib NAMES libSym.a PATHS ${solver_search_path} NO_DEFAULT_PATH NO_SYSTEM_ENVIRONMENT_PATH)
    set_property(TARGET sym_if PROPERTY IMPORTED_LOCATION ${sym_lib})
    find_library(osisym_lib NAMES libOsiSym.a PATHS ${solver_search_path} NO_DEFAULT_PATH NO_SYSTEM_ENVIRONMENT_PATH)
