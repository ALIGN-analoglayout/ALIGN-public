...
if(NOT cbc_POPULATED)
  ...
  if (NOT ilp_solver_lib)
    ...
    target_include_directories(ilp_solver_if INTERFACE ${ilpsolverif_SOURCE_DIR}/lib)
    find_library(cbc_lib NAMES libCbc.a PATHS ${ilpsolverif_SOURCE_DIR}/lib)
    set_property(TARGET cbc_if PROPERTY IMPORTED_LOCATION ${cbc_lib})
    find_library(cbcsolver_lib NAMES libCbcSolver.a PATHS ${ilpsolverif_SOURCE_DIR}/lib)
    set_property(TARGET cbcsolver_if PROPERTY IMPORTED_LOCATION ${cbcsolver_lib})
    find_library(clp_lib NAMES libClp.a PATHS ${ilpsolverif_SOURCE_DIR}/lib)
    set_property(TARGET clp_if PROPERTY IMPORTED_LOCATION ${clp_lib})
    find_library(cgl_lib NAMES libCgl.a PATHS ${ilpsolverif_SOURCE_DIR}/lib)
    set_property(TARGET cgl_if PROPERTY IMPORTED_LOCATION ${cgl_lib})
    find_library(osi_lib NAMES libOsi.a PATHS ${ilpsolverif_SOURCE_DIR}/lib)
    set_property(TARGET osi_if PROPERTY IMPORTED_LOCATION ${osi_lib})
    find_library(osiclp_lib NAMES libOsiClp.a PATHS ${ilpsolverif_SOURCE_DIR}/lib)
    set_property(TARGET osiclp_if PROPERTY IMPORTED_LOCATION ${osiclp_lib})
    find_library(coinutils_lib NAMES libCoinUtils.a PATHS ${ilpsolverif_SOURCE_DIR}/lib)
    set_property(TARGET coinutils_if PROPERTY IMPORTED_LOCATION ${coinutils_lib})
    find_library(clpsolver_lib NAMES libClpSolver.a PATHS ${ilpsolverif_SOURCE_DIR}/lib)
    set_property(TARGET clpsolver_if PROPERTY IMPORTED_LOCATION ${clpsolver_lib})
    find_library(osicbc_lib NAMES libOsiCbc.a PATHS ${ilpsolverif_SOURCE_DIR}/lib)
    set_property(TARGET osicbc_if PROPERTY IMPORTED_LOCATION ${osicbc_lib})
    find_library(sym_lib NAMES libSym.a PATHS ${ilpsolverif_SOURCE_DIR}/lib)
    set_property(TARGET sym_if PROPERTY IMPORTED_LOCATION ${sym_lib})
    find_library(osisym_lib NAMES libOsiSym.a PATHS ${ilpsolverif_SOURCE_DIR}/lib)
