...
class Graph {
  ...
  Graph(std::vector<std::pair<int, int> >& global_path, std::vector<std::vector<int> >& conectedTile, std::vector<int>& Tile_Source,
        std::vector<int>& Tile_Dest);
  void CreateAdjacentList_Global_Path(std::vector<std::pair<int, int> >& global_path, std::vector<std::vector<int> >& conectedTile,
