...
void DetailRouter::ConvertRect2GridPoints(std::vector<std::vector<RouterDB::point> >& plist, int mIdx, int LLx, int LLy, int URx, int URy) {
  ...
  std::cout<<"Power Grid Convert origin box"<<LLx<<" "<<LLy<<" "<<URx<<" "<<URy<<std::endl; 
  ...
  if(drc_info.Metal_info[mIdx].direct==0) { // vertical metal layer
    ...
    std::cout<<"Power Grid metal pitches "<<curlayer_unit<<std::endl;
    ...
    for(int x=boundX; x<newURx; x+=curlayer_unit) {
      if(mIdx!=obs_l) {
        ...
        std::cout<<"Power Grid Convert new box"<<boundX<<" "<<LLy<<" "<<newURx<<" "<<newURy<<std::endl;  
    ...
    for(int y=boundY; y<newURy; y+=curlayer_unit) {
      if(mIdx!=obs_l) {
        ...
        std::cout<<"Power Grid Convert new box"<<boundX<<" "<<boundY<<" "<<newURx<<" "<<newURy<<std::endl;
