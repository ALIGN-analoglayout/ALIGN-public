...
//    // added by wbxu
    ...
    void AssignMetal(RouterDB::terminal &temp_Terminal, int horizontal_index, int vertical_index);
    void Determine_Terminal_Center(int horizontal_index, int vertical_index);
    void PlaceTerminal();
