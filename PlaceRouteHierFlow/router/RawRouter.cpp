...
RawRouter::RawRouter() : topName("defaultDesign") {
  ...
  this->path_number = 1;
  this->layerNo = 0;
  PnRDB::Drc_info drc_info2;
  drc_info2.MaxLayer = 0;
  drc_info2.Metalmap.clear();
  drc_info2.Viamap.clear();
  drc_info2.Metal_info.clear();
  drc_info2.Via_info.clear();
  drc_info2.MaskID_Metal.clear();
  drc_info2.MaskID_Via.clear();
...
std::vector<std::vector<RouterDB::point>> RawRouter::FindPlist(std::set<RouterDB::SinkData, RouterDB::SinkDataComp>& Set_x, RouterDB::point LL,
                                                               RouterDB::point UR) {
...
std::set<std::pair<int, RouterDB::point>, RouterDB::pointSetComp> RawRouter::findviaset(
    std::set<std::pair<int, RouterDB::point>, RouterDB::pointSetComp>& Pset_via, RouterDB::point LL, RouterDB::point UR) {
...
std::set<RouterDB::SinkData, RouterDB::SinkDataComp> RawRouter::Findset(std::set<RouterDB::SinkData, RouterDB::SinkDataComp>& Set_x, RouterDB::point LL,
                                                                        RouterDB::point UR) {
...
std::vector<std::set<RouterDB::point, RouterDB::pointXYComp>> RawRouter::FindsetPlist(std::set<RouterDB::SinkData, RouterDB::SinkDataComp>& Set_x,
