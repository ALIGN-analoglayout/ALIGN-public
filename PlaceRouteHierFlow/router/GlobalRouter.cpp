...
// wbxu: 20190708 the following codes are to use ILP to choose candidates
/*
void GlobalRouter::ViaSpacingCheckFunc(std::set< std::pair<int,int>, IntPairComp >& checked, int val, int Midx, int ALLx, int ALLy, int AURx, int AURy, int h,
int i, int j) { slackInfo tmpSI; std::pair<int,int> tpair; std::set<int> overlapSet=this->CheckOverlap(this->ViaPieces.at(Midx), ALLx, ALLy, AURx, AURy);
...
void GlobalRouter::MetalSpacingCheckFunc(std::set< std::pair<int,int>, IntPairComp >& checked, int val, int Midx, int ALLx, int ALLy, int AURx, int AURy, int h,
int i, int j) { slackInfo tmpSI; std::pair<int,int> tpair; std::set<int> overlapSet=this->CheckOverlap(this->MetalPieces.at(Midx), ALLx, ALLy, AURx, AURy);
  for(std::set<int>::iterator it=overlapSet.begin(); it!=overlapSet.end(); ++it) {
