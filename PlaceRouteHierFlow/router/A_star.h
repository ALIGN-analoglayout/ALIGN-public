...
class A_star {
  ...
  int Manhattan_distan_dest(int sindex, Grid &grid);
  int Manhattan_distan_dest_via(int sindex, Grid &grid);
  int Manhattan_distan_source(int sindex, Grid &grid);
  int Manhattan_distan_source_via(int sindex, Grid &grid);
