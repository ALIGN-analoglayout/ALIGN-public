...
class ILP_solver {
  ...
  double HPWL_extend_net_priority = 0, cfcost = 0, rcost = 0.;
  ...
  double CalculateCFCost(const design& mydesign, const SeqPair& curr_sp) const;
  double CalculateRectangularIslandCost(const design& mydesign, const SeqPair& curr_sp) const;
