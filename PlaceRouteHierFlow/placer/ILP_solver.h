...
class ILP_solver {
  ...
  bool FrameSolveILPCbc(const design& mydesign, const SeqPair& curr_sp, const PnRDB::Drc_info& drcInfo, bool flushlb, const vector<placerDB::point>* prev, const int num_threads = 1);
  bool FrameSolveILPCbc_noflip(const design& mydesign, const SeqPair& curr_sp, const PnRDB::Drc_info& drcInfo, bool flushlb, const vector<placerDB::point>* prev, const int num_threads = 1);
  ...
  bool FrameSolveILP(const design& mydesign, const SeqPair& curr_sp, const PnRDB::Drc_info& drcInfo, const int num_threads = 1, bool flushlb = true, const vector<placerDB::point>* prev = nullptr)
  {
    ...
    return FrameSolveILPCbc_noflip(mydesign, curr_sp, drcInfo, flushlb, prev, num_threads);
