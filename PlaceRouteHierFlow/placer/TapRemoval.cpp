...
TapRemoval::TapRemoval(const PnRDB::hierNode& node, const unsigned xdist, const unsigned ydist) : _xdist(xdist), _ydist(ydist), _name(node.name), _graph(nullptr)
{
...
long TapRemoval::deltaArea(map<string, int>* swappedIndices, const bool removeAllTaps, const bool isTop) const
{
