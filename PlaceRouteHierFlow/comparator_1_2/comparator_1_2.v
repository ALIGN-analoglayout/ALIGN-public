...
module comparator_1_2 ( vip, vin, vcc, clk, vop, vss, von ); 
input vip, vin, vcc, clk, vop, vss, von;
...
Switch_PMOS_n12_X1_Y1 mp0 ( .D(vop), .G(von), .S(vcc), .Bg(vcc) ); 
Switch_PMOS_n12_X1_Y1 mp1 ( .D(von), .G(vop), .S(vcc), .Bg(vcc) ); 
