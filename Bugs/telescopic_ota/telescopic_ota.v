...
module telescopic_ota ( vbiasn, vinn, voutn, vinp, vbiasp1, d1, vbiasp2, vdd, voutp, vss, vbiasnd ); 
input vbiasn, vinn, voutn, vinp, vbiasp1, d1, vbiasp2, vdd, voutp, vss, vbiasnd;
