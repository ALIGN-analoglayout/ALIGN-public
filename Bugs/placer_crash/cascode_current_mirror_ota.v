...
module cascode_current_mirror_ota ( vbiasn, vinn, vdd, vbiasp, vss, vbiasnd, id, voutp, vinp ); 
input vbiasn, vinn, vdd, vbiasp, vss, vbiasnd, id, voutp, vinp;
...
CMC_PMOS_n12_X5_Y2 m26_m22 ( .DA(net16), .G(vbiasp), .DB(vbiasnd), .SA(net015), .SB(net06) ); 
CMC_PMOS_n12_X5_Y2 m27_m23 ( .DA(net27), .G(vbiasp), .DB(voutp), .SA(net021), .SB(net024) ); 
