...
if __name__ == "__main__":
    ...
    res = gen_viewer_json( hN, pdk_fn=args.pdk_fn, draw_grid=args.draw_grid, global_route_json=args.global_route_json, json_dir=args.json_dir, checkOnly=args.check)
