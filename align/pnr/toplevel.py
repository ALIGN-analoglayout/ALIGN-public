...
def place(*, DB, opath, fpath, numLayout, effort, idx, lambda_coeff, select_in_ILP, placer_time_limit):
    ...
    curr_plc = PnR.PlacerIfc(current_node, numLayout, opath, effort, DB.getDrc_info(), hyper, select_in_ILP, placer_time_limit)
...
def place_and_route(*, DB, opath, fpath, numLayout, effort, adr_mode, PDN_mode, verilog_d, router_mode, gui, skipGDS, lambda_coeff, scale_factor,
                    reference_placement_verilog_json, nroutings, select_in_ILP, placer_time_limit):
    TraverseOrder = DB.TraverseHierTree()
...
def toplevel(args, *, PDN_mode=False, adr_mode=False, results_dir=None, router_mode='top_down', gui=False, skipGDS=False,
             lambda_coeff=1.0, scale_factor=2, reference_placement_verilog_json=None, nroutings=1, select_in_ILP=False,
             placer_time_limit=5):
    ...
    results_name_map = place_and_route(DB=DB, opath=opath, fpath=fpath, numLayout=numLayout, effort=effort, adr_mode=adr_mode, PDN_mode=PDN_mode,
                                       ...
                                       scale_factor=scale_factor, reference_placement_verilog_json=reference_placement_verilog_json, nroutings=nroutings,
                                       select_in_ILP=select_in_ILP, placer_time_limit=placer_time_limit)
