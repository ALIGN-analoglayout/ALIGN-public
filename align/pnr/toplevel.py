...
def toplevel(args, *, PDN_mode=False, adr_mode=False, results_dir=None, router_mode='top_down',
    ...
    fpath, cap_map, cap_lef_s = cap_placer_driver(toplevel_args=args, results_dir=results_dir)
    ...
    res_dict = router_driver(fpath=fpath, cap_map=cap_map, cap_lef_s=cap_lef_s,
