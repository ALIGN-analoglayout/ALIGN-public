...
def place( *, DB, opath, fpath, numLayout, effort, idx, lambda_coeff, select_in_ILP, use_analytical_placer):
...
def place_and_route( *, DB, opath, fpath, numLayout, effort, adr_mode, PDN_mode, verilog_d, router_mode, gui, skipGDS, lambda_coeff, scale_factor, reference_placement_verilog_json, nroutings, select_in_ILP, use_analytical_placer):
    TraverseOrder = DB.TraverseHierTree()

    for idx in TraverseOrder:
        place( DB=DB, opath=opath, fpath=fpath, numLayout=numLayout, effort=effort, idx=idx, lambda_coeff=lambda_coeff, select_in_ILP=select_in_ILP, use_analytical_placer=use_analytical_placer)
...
def toplevel(args, *, PDN_mode=False, adr_mode=False, results_dir=None, router_mode='top_down', gui=False, skipGDS=False, lambda_coeff=1.0, scale_factor=2, reference_placement_verilog_json=None, nroutings=1, select_in_ILP=False, use_analytical_placer=False):
