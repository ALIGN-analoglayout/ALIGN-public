...
def gen_outputs_ac_1(WORK_DIR, design, simulation_list, spec_list_ac_1, param_name_list):
    infile_final = design + "_tb_new.sp"
    spicelogfile = design + ".log"
    mdlfile = design + ".mdl"
    measurefile_ac_1 = design + ".measure"
    tc_directory = "/" + design + "/"

    os.chdir(WORK_DIR + tc_directory + "/sims/outputs_ac_1")
...
def get_range_ac_1(WORK_DIR, design, simulation_list, param_list, spec_list_ac_1):
    tc_directory = "/" + design + "/"
    os.chdir(WORK_DIR + tc_directory + "sims/outputs_ac_1")
    ...
    fdb = pd.read_csv(WORK_DIR + tc_directory + "outputs/critical_range_template.csv")
    ...
    if not os.path.exists(WORK_DIR + tc_directory + "critical_range_all"):
        os.mkdir(WORK_DIR + tc_directory + "critical_range_all")
    os.system("cp "+"critical_range_ac_1.csv"+" "+ WORK_DIR + tc_directory + "critical_range_all/critical_range_ac_1.csv")
    os.chdir(WORK_DIR)
...
def gen_outputs_ac_2(WORK_DIR, design, simulation_list, spec_list_ac_2, param_name_list):
    tc_directory = "/" + design + "/"
    os.chdir(WORK_DIR + tc_directory + "sims/outputs_ac_2")
    infile_final = design + "_tb_new.sp"
    spicelogfile = design + ".log"
...
def get_range_ac_2(WORK_DIR, design, simulation_list, param_list, spec_list_ac_2):
    tc_directory = "/" + design + "/"
    param_with_zero_sense = list()
    os.chdir(WORK_DIR + tc_directory + "sims/outputs_ac_2")
    ...
    if not os.path.exists(WORK_DIR + tc_directory + "critical_range_all"):
        os.mkdir(WORK_DIR + tc_directory + "critical_range_all")
    os.system("cp "+"critical_range_ac_2.csv"+" "+ WORK_DIR + tc_directory + "critical_range_all/critical_range_ac_2.csv")
    os.chdir(WORK_DIR)
    return param_with_zero_sense
...
def gen_outputs_ac_3(WORK_DIR, design, simulation_list, spec_list_ac_3, param_name_list):
    tc_directory = "/" + design + "/"
    os.chdir(WORK_DIR + tc_directory + "sims/outputs_ac_3")
    infile_final = design + "_tb_new.sp"
    spicelogfile = design + ".log"
...
def get_range_ac_3(WORK_DIR, design, simulation_list, param_list, spec_list_ac_3):
    tc_directory = "/" + design + "/"
    param_with_zero_sense = list()
    os.chdir(WORK_DIR + tc_directory + "sims/outputs_ac_3")
    ...
    if not os.path.exists(WORK_DIR + tc_directory + "critical_range_all"):
        os.mkdir(WORK_DIR + tc_directory + "critical_range_all")
    os.system("cp "+"critical_range_ac_3.csv"+" "+ WORK_DIR + tc_directory + "critical_range_all/critical_range_ac_3.csv")
    os.chdir(WORK_DIR)
    return param_with_zero_sense
...
def gen_outputs_dc_1(WORK_DIR,
                     ...
                     param_name_list):
    tc_directory = "/" + design + "/"
    os.chdir(WORK_DIR +  tc_directory + "sims/outputs_dc_1")
    infile_final = design + "_tb_new.sp"
    ...
    if not os.path.exists(WORK_DIR + tc_directory + "critical_range_all"):
        os.mkdir(WORK_DIR + tc_directory + "critical_range_all")
    os.system("cp "+"critical_range_dc_1.csv"+" "+ WORK_DIR + tc_directory + "critical_range_all/critical_range_dc_1.csv")
    os.chdir(WORK_DIR)
    return []
...
def gen_outputs_tran_1(WORK_DIR,design,simulation_list,spec_list_tran_1,param_name_list):
    tc_directory = "/" + design + "/"
    os.chdir(WORK_DIR + tc_directory + "sims/outputs_tran_1")
    infile_final = design + "_tb_new.sp"
    spicelogfile = design + ".log"
...
def get_range_tran_1(WORK_DIR, design, simulation_list, param_list, spec_list_tran_1):
    tc_directory = "/" + design + "/"
    param_with_zero_sense = list()
    os.chdir(WORK_DIR + tc_directory + "sims/outputs_tran_1")
    ...
    if not os.path.exists(WORK_DIR + tc_directory + "critical_range_all"):
        os.mkdir(WORK_DIR + tc_directory + "critical_range_all")
    os.system("cp "+"critical_range_tran_1.csv"+" "+ WORK_DIR + tc_directory + "critical_range_all/critical_range_tran_1.csv")
    os.chdir(WORK_DIR)
    return param_with_zero_sense
...
def generate_outputs_with_paramset_ac_1(WORK_DIR, design, spec_list_ac_1, MODE):
    tc_directory = "/" + design + "/"
    df_bounds = pd.read_csv(WORK_DIR + tc_directory + "outputs/node_under_test_for_smartforce.csv")
    param_list = df_bounds.columns.tolist()
    infile_final = design + "_tb_new_for_ML.sp"
    mdlfile = design + ".mdl"
    measurefile = design + ".measure"
    spicelogfile = design + ".log"
    os.chdir(WORK_DIR + tc_directory + "sims/outputs_ac_1_FT")
    print("Current simulation: ac_1")
    filenames = list()
...
def generate_outputs_with_paramset_ac_2(WORK_DIR, design, spec_list_ac_2, MODE):
    ...
    measurefile_ac_2 = design + "_ac_2.measure"
    spicelogfile = design + ".log"
    os.chdir(WORK_DIR + tc_directory + "sims/outputs_ac_2_FT")
    print("Current simulation: ac_2")
    filenames = list()
...
def generate_outputs_with_paramset_ac_3(WORK_DIR, design, spec_list_ac_3, MODE):
    ...
    measurefile_ac_3 = design + "_ac_3.measure"
    spicelogfile = design + ".log"
    os.chdir(WORK_DIR + tc_directory + "sims/outputs_ac_3_FT")
    print("Current simulation: ac_3")
    filenames = list()
...
def generate_outputs_with_paramset_dc_1(WORK_DIR,
    ...
    os.chdir(WORK_DIR + tc_directory + "sims/outputs_dc_1_FT")
    print("Current simulation: dc_1")
...
def generate_outputs_with_paramset_tran_1(WORK_DIR, design, spec_list_tran_1, MODE):
    ...
    measurefile_tran_1 = design + "_tran_1.measure"
    spicelogfile = design + ".log"
    os.chdir(WORK_DIR + tc_directory + "sims/outputs_tran_1_FT")
    print("Current simulation: tran_1")
    filenames = list()
    for item in spec_list_tran_1:
        filenames.append(item.name+"_"+str(MODE))
