...
#include "/scratch/anaconda/pkgs/python-3.7.3-h0371630_0/include/python3.7m/Python.h"
#include "/scratch/anaconda/pkgs/python-3.7.3-h0371630_0/include/python3.7m/unicodeobject.h"
#include <cstdio>
#include "Pdatatype.h"
#include "design.h"
#include "SeqPair.h"
...
class ConstGraph
{
  ...
  public:
    ...
    double MLPredict(design& caseNL, SeqPair& caseSP); // TD: Added by me
    double CallMLModelPython(string spec_name, std::vector<double> parasitic_value); // TD: Added by me
