...
if __name__ == "__main__":
    ...
    headlabel = Label(root,
                      text=' Welcome to constraint writer package',
                      fg='black',
                      bg="cyan")
    ...
    label4 = Label(
        root,
        text=
        "Symmetrical Nets(pin list) : \ne.g neta pin1 pin2, netb pinq pinr; ",
        fg='black',
        bg='white')
    ...
    button2 = Button(root,
                     text="Generate constraint json",
                     bg="green",
                     fg="black",
                     command=generate_const_json)
