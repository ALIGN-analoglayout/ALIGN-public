...
generate_png:
	...
	docker run --rm --mount source=layoutVol,target=/layout -it layout_convert /bin/bash -c "/Build/ThirdParty/Klayout/gds2png.sh /layout/$(DESIGN_NAME).gds /layout/$(DESIGN_NAME).png"
