...
class UnitCell:
    ...
    def unit( self, x, y):
        ...
        m2_tracks = round(y_total/m2Pitch)
...
##### Routing for differntial pair
        ...
        if (x_cells - 1 - x) != 0:
            ...
            if x == 1:
                uc.v2Segment('v2', (m1Offset + (gate - 1 + x*gate)*m1Pitch - (v1Width//2)), (m1Offset + (gate - 1 + x*gate)*m1Pitch + (v1Width//2)), y*(((m2_tracks-y_cells + 1)//y_cells)+1) + 4)
            ...
            if x == 2:
                uc.v1Segment('v1', (m1Offset + (gate - 1 + x*gate)*m1Pitch - (v1Width//2)), (m1Offset + (gate - 1 + x*gate)*m1Pitch + (v1Width//2)), y*(((m2_tracks-y_cells + 1)//y_cells)+1) + 1)
