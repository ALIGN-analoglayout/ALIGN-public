...
class spiceParser:
    ...
    def _show_circuit_graph(self,filename, graph):
        for subgraph in nx.connected_component_subgraphs(graph):
            ...
            if not os.path.exists("../train_graph_images"):
                os.mkdir("../train_graph_images")
            plt.savefig("../train_graph_images/"+filename+'.png')

            if not os.path.exists("../train_graphs"):
                os.mkdir("../train_graphs")
            nx.write_yaml(subgraph,"../train_graphs/"+filename+".yaml")
